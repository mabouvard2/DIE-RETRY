...
namespace DieandRetry.core.Partie
{
    struct AnimationPlayer
    {
        ...
        /// </summary>
        public AnimationForPlayer Animation
        {
            get { return animation; }
        }
        AnimationForPlayer animation;
        ...
        public void PlayAnimation(AnimationForPlayer animation)
        {
        ...
        public void Draw(GameTime gameTime, SpriteBatch spriteBatch, Vector2 position, SpriteEffects spriteEffects)
        {
            ...
            Rectangle source = new Rectangle(FrameIndex * Animation.FrameWidth, FrameIndex * Animation.FrameHeight, Animation.FrameWidth, Animation.FrameHeight);

            // Dessine la frame en court
            spriteBatch.Draw(Animation.Texture, position, source, Color.White, 0.0f, Origin, 1.0f, spriteEffects, 1f);
        }
    }
}
